...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="<c:url value="https://getbootstrap.com/dist/css/bootstrap.css" />" rel="stylesheet">
 
    <!-- Custom styles for this template -->
    <link href="<c:url value="https://getbootstrap.com/dist/css/signin.css" />" rel="stylesheet">
...
<body>
 <!-- name="_spring_security_remember_me"  ----   CHECKBOX-->
